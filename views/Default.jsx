        ...
        return (
            <html lang="en">
                <head>
                    ...
                    <title>Home.io</title>
                    {/* Bootstrap CSS for Some Default Styling */}
                    {/* Google Fonts */}
                    <link
                        rel="stylesheet"
                ...
                <body>
                    ...
                    <footer className="fixed-bottom bg-light">
                        <p className="d-flex justify-content-center align-middle mt-3">Contact Me: <a href="mailto:LukeFleming90@gmail.com">LukeFleming90@gmail.com</a></p>
